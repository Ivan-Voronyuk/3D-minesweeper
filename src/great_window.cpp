...
Level1_window::Level1_window(Point xy, int w, int h, const std::string& title)
    : Window{xy, w, h, title},
...
Level2_window::Level2_window(Point xy, int w, int h, const std::string& title)
    : Window{xy, w, h, title},
...
Level3_window::Level3_window(Point xy, int w, int h, const std::string& title)
    : Window{xy, w, h, title},
